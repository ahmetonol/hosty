...
final class HostProfile {
    ...
    func generateHostsFileContent() -> String {
        ...
        // macOS için gerekli sistem entry'lerini ekle
        content += "##\n"
        ...
        // Kullanıcı tanımlı entry'leri ekle (sistem entry'lerini atla)
        ...
        // Disabled entry'ler varsa onları da ekle (yorum olarak, sistem entry'lerini atla)
